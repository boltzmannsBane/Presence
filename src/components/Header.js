    ...
    return (
        <>
            ...
            <nav>
                    ...
                    >
                        <Tab label="Gallery" icon={<ImageIcon />} onClick={() => history.replace(`/users/${id}/gallery`)} {...a11yProps(0)} />
                        <Tab label="Tweets" icon={<SubjectIcon />} onClick={() => history.replace(`/users/${id}/tweets`)} {...a11yProps(1)} />
                    </Tabs>
            </nav>
        </>
    )
